 ...
 ('N-Boc deprotection',): 
  ...
  'Deprotection with water': {'Reagent': ['[H2O]'],
   'Stages': {0: {'Templates': ['[O;+0:3]-[C:2](=[O:1])-[N;+0:8](-[#6:7])>>[O;+0:3]-[C:2](=[O;H1;+1:1])-[N;+0:8](-[#6:7])'],
    ...
    3: {'Templates': ['[#6:4]-[O;H0;+0:3]-[C:2](-[O;H1;+0:1])(-[O:5])-[N;+0:8](-[#6:7])>>[#6:4]-[O;H0;-1:3].[C:2](=[O;H1;+1:1])(-[O:5])-[N;+0:8](-[#6:7])'],
     'pKa': [None],
    ...
    5: {'Templates': ['[C:2](=[O;H0;+0:1])(-[O;H1;D1:5])-[N;+0:8](-[#6:7])>>[C:2](=[O;H0;+0:1])(-[O;H0;-1:5])-[N;+0:8](-[#6:7])'],
     'pKa': [{'B': 4.7}],
     'Description': 'Deprotonation of carboxylic acid'},
    6: {'Templates': ['[C:2](=[O;H0;+0:1])(-[O;H0;-1:5])-[N;+0:8](-[#6:7])>>[C:2](=[O;H0;+0:1])=[O;H0;+0:5].[N;-1:8](-[#6:7])'],
     'pKa': [None],
     'Description': 'Evolution of CO2 and production of amide anion'},
    7: {'Templates': ['[N;H1;-1:8](-[#6:7])>>[N;H2;+0:8](-[#6:7])',
      '[N;H0;-1:8](-[#6:7])>>[N;H1;+0:8](-[#6:7])'],
     'pKa': [{'A': 37}, {'A': 37}],
     'Description': 'Protonation of amide anion'}}},
...
#   'Error in reactants': {'Reagent': ['[NH1;D0]'], 'Stages': {}},  ### Todo: handle this error
 ...
 'Fischer-Speier esterification'): {'Condensation using DCC': {'Reagent': ['[N]=[C]=[N]'],
  ...
  'Esterification': {'Reagent': ['[C](=[O])-[O;H1]'],
                                 # Acidic condition
...
('Bromo Suzuki coupling',
  ...
  'Iodo Miyaura boration'): 
   ...
   'Reaction with PdCl2': {'Reagent': ['[Cl,Br,I,O][Pd;+0][Cl,Br,I,O]', '[P;D3]', '[P;D3]'],                           
   'Stages': {
...
#      'Description': 'Palladium-ligand formation'},
   ...
   'Reaction with Pd coordinated with 3 or 4 ligands': {'Reagent': ['[!Cl,!Br,!I,!O][Pd;D3,D4;+0][!Cl,!Br,!I,!O]'],                           
 ...
 ('Mitsunobu aryl ether synthesis',
  ...
  'Mitsunobu ester synthesis'): {'Reaction': {'Reagent': None,
 ...
 ('O-TBS deprotection',
  ...
  'O-TIPS deprotection'): {'Fluoride condition': {'Reagent': ['[F;+0;H1]'],
 ...
 'Bromo Stille reaction',
  ...
  'Iodo Stille reaction'): {'Reaction with element Pd': 
   ...
   'Stages': {0: {'Templates': ['[Cl,Br,I,O:2]-[Pd;+0:1]-[Cl,Br,I,O:3].[P:4].[P:5]>>[Cl,Br,I,O:2]-[Pd;+0:1](-[P:4])(-[P:5])-[Cl,Br,I,O:3]',
                              '[Cl,Br,I,O:2]-[Pd;+0:1]-[Cl,Br,I,O:3].([P:4].[P:5])>>[Cl,Br,I,O:2]-[Pd;+0:1](-[P:4])(-[P:5])-[Cl,Br,I,O:3]'],
     'pKa': [None],
     'Description': 'Palladium-ligand formation'},       
   ...
   'Stages': {0: {'Templates': ['[Cu:1]-[Cl,Br,I;H0:2].[#6;H1:3]#[#6;H0:4]>>[Cu:1]-[#6;H0;+0:3]#[#6:4].[Cl,Br,I;H1;+0:2]'],
     'pKa': [None],
     'Description': 'Copper activation'},             
             1: {'Templates': ['[Cl,Br,I:7]-[#6;+0:5].[Pd;D3;+0:6]-[*;8]>>[Cl,Br,I:7]-[Pd:6]-[#6;+0:5].[*;8]',
                              '[Cl,Br,I:7]-[#6;+0:5].[Pd;D4;+0:6](-[*;9])-[*;8]>>[Cl,Br,I:7]-[Pd:6]-[#6;+0:5].[*;8].[*;9]'],
     'pKa': [None, None],
     'Description': 'Oxidative addition'},
    2:{'Templates': ['[F,Cl,Br,I:5]-[Pd:1]-[#6:6].[Cu:2]-[#6:3]#[#6:4]>>[F,Cl,Br,I:5]-[Cu:2].[#6:6]-[Pd:1]-[#6:3]#[#6:4]',
                     '[Cl,Br,I:7]-[Pd:6]-[#6;+0:5].[Sn:1]-[*:2]>>[*:2]-[Pd:6]-[#6;+0:5].[Sn:1]-[Cl,Br,I:7]'],
...
#      'pKa': [{'B': 6},{'B': 17}, {'B': 17}, {'B': 17}, {'B': 17}],
#      'Description': 'Deprotonation of alpha position carbon'},
#     1: {'Templates': ['[#6:3](=[#8:4])[#6;-1:5].[#6;H1:6](=[#8:7])>>[#6:3](=[#8:4])[#6;+0:5]-[#6;H1:6]-[#8;-1:7]'],
#      'pKa': [None],
#      'Description': ''},
#     2: {'Templates': ['[#6:3](=[#8:4])-[#6;+0:5]-[#6;H1:6]-[#8;-1:7]>>[#6:3](=[#8:4])-[#6;+0:5]-[#6;H1:6]-[#8;H1;+0:7]'],
#      'pKa': [None],
#      'Description': ''},
#     3: {'Templates': ['[#6:3](=[#8:4])-[#6;H2;+0:5]-[#6;H1:6]-[#8;H1;+0:7]>>[#6:3](=[#8:4])-[#6;H1;-1:5]-[#6;H1:6]-[#8;H1;+0:7]',
#       '[#6:3](=[#8:4])-[#6;H1;+0:5]-[#6;H1:6]-[#8;H1;+0:7]>>[#6:3](=[#8:4])-[#6;H0;-1:5]-[#6;H1:6]-[#8;H1;+0:7]'],
#      'pKa': [None, None],
#      'Description': ''},
#     4: {'Templates': ['[#6:3](=[#8:4])-[#6;-1:5]-[#6;H1:6]-[#8;H1;+0:7]>>[#6:3](=[#8:4])-[#6;+0:5]=[#6;H1:6].[#8;H1;-1:7]'],
#      'pKa': [None],
#      'Description': ''}}}},
 ...
 'Claisen-Schmidt condensation'): {'Reaction': {'Reagent': None,
   'Stages': {0: {'Templates': ['[#8:1]=[#6:2]-[#6;H2:3]-[#6:4]=[#8:5]>>[#8:1]=[#6:2]-[#6;H1;-1:3]-[#6:4]=[#8:5]',
     ...
     'pKa': [{'B': 6},{'B': 17}, {'B': 17}, {'B': 17}, {'B': 17}],
     'Description': 'Deprotonation of alpha position carbon'},
    1: {'Templates': ['[#6;H2;-1:3].[#6:4]=[#8:5]>>[#6;H2;+0:3]-[#6:4]-[#8;-1:5]',
                      '[#6;H1;-1:3].[#6:4]=[#8:5]>>[#6;H1;+0:3]-[#6:4]-[#8;-1:5]'],
     'pKa': [None,None],
 ...
 ('Wohl-Ziegler bromination',): {'Reaction with radical': {'Reagent': ['[#7,#8;D2]-,=[#7,#8;D2]'],
  ...
  'Reaction with NBS': {'Reagent': None,
 ...
 ('Bromo Grignard reaction',
  ...
  'Grignard + acid chloride ketone synthesis'): {'Reaction': {'Reagent': None,
 ...
 ('Amide Schotten-Baumann',
  ...
  'N-Cbz protection'): {'Reaction': {'Reagent': None,
   'Stages': {0: {'Templates': ['[#7;H2;+0:1]-[#6:2].[F,Cl,Br,I:3]-[C,S;H0;+0:4](=[O:5])>>[F,Cl,Br,I:3]-[C,S;H0;+0:4](-[#7;H2;+1:1]-[#6:2])(-[O;-1:5])',
     ...
     'pKa': [None, None, None],
     'Description': 'Amine addition'},
    1: {'Templates': ['[F,Cl,Br,I:3]-[C,S;H0;+0:4](-[#7;H2;+1:1]-[#6:2])(-[O;-1:5])>>[F,Cl,Br,I:3]-[C,S;H0;+0:4](-[#7;H1;+0:1]-[#6:2])(-[O;H0;-1:5])',
      '[F,Cl,Br,I:3]-[C,S;H0;+0:4](-[#7;H1;+1:1]-[#6:2])(-[O;-1:5])>>[F,Cl,Br,I:3]-[C,S;H0;+0:4](-[#7;H0;+0:1]-[#6:2])(-[O;H0;-1:5])',
      '[F,Cl,Br,I:3]-[C,S;H0;+0:4](-[#8;H1;+1:1]-[#6:2])(-[O;-1:5])>>[F,Cl,Br,I:3]-[C,S;H0;+0:4](-[#8;H0;+0:1]-[#6:2])(-[O;H0;-1:5])'],
     'pKa': [{'B': -1.7}, {'B': 5}, {'B': 5}],
     'Description': 'Deprotonation'},
    2: {'Templates': ['[F,Cl,Br,I:3]-[C,S;H0;+0:4](-[#7,#8;+0:1]-[#6:2])(-[O;H0;-1:5])>>[F,Cl,Br,I;-1:3].[C,S;H0;+0:4](-[#7,#8;+0:1]-[#6:2])(=[O;H0;+0:5])'],
     'pKa': [None],
 ...
 ('CO2H-Me deprotection',
  ...
  'Ester hydrolysis'): {'Deprotection with OH-': {'Reagent': ['[O;H1;-1]'],
  ...
  'Deprotection with Alkali hydroxide': {'Reagent': ['[Li,Na,K][O;H1]'],
   'Stages': {0: {'Templates': ['[#8;H1;-1:5].[#6:4]-[O;H0;+0:1]-[C;H0;+0:2]=[O:3]>>[#6:4]-[O;H0;+0:1]-[C;H0;+0:2]([#8;D1;H1;+0:5])-[O;H0;-1:3]',
    ...
    1: {'Templates': ['[#6:4]-[O;H0;+0:1]-[C;H0;+0:2]([#8;+0:5])-[O;H0;-1:3]>>[O;H0;+0:3]=[C;H0;+0:2]-[#8;+0:5].[#6:4]-[O;H0;-1:1]'],
     'pKa': [None],
     'Description': 'Alkoxide leaves'}}},
  'Deprotection with water': {'Reagent': ['[O;H2]'],
