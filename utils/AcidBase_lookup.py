Acid_base = [
    ...
    # Heterocyclic amine
    #Pyrimidine
    {'Acid': '[n;+1&!$([#7]~[#7]);H1:100]1[c:99][c:98][c:97][n:96][c:95]1', 'Base': '[n&!$([#7]~[#7]);H0:100]1[c:99][c:98][c:97][n:96][c:95]1', 'pKa': 1.3, 'role' : ['A', 'B']},
    #Pyridine
    {'Acid': '[n;+1&!$([#7]~[#7]);H1:100]1[c:99][c:98][c:97][c:96][c:95]1', 'Base': '[n&!$([#7]~[#7]);H0:100]1[c:99][c:98][c:97][c:96][c:95]1', 'pKa': 5.25, 'role' : ['A', 'B']},
    #Imidazole
    {'Acid': '[c:100]1[n;H1:99][c:96][c:98][n;H1&!$([#7]~[#7]);+1:97]1', 'Base': '[c:100]1[n;H1:99][c:96][c:98][n;H0;+0&!$([#7]~[#7]):97]1', 'pKa': 6.29, 'role' : ['A', 'B']},
    #Pyrrole
    {'Acid': '[c:100]1[n;H2&!$([#7]~[#7]);+1:99][c:96][c:98][c:97]1', 'Base': '[c:100]1[n;H1;+0&!$([#7]~[#7]):99][c:96][c:98][c:97]1', 'pKa': 0.4, 'role' : ['A', 'B']},
