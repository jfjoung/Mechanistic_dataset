 ...
 ('N-Boc deprotection',):
  ...
  #    'Description': 'Protonation of amide anion'}}},
   ...
   'Stages': {0: {'Templates': ['[O;+0:3]-[C:2](=[O:1])-[N;+0:8](-[#6:7])>>[O;H1;+1:3]-[C:2](=[O:1])-[N;+0:8](-[#6:7])',
    ...
    1: {'Templates': ['[C;H3;+0:9]-[C;+0:4]-[O;H1;+1:3]-[C:2](=[O:1])-[N;+0:8](-[#6:7])>>[C;H2;+0:9]=[C;+0:4].[O;H1;+0:3]-[C:2](=[O:1])-[N;+0:8](-[#6:7])',
                      '[C;+0:4]-[O;H1;+1:3]-[C:2](=[O:1])-[N;+0:8](-[#6:7]).[Cl,Br,I,O;-1:10]>>[Cl,Br,I,O;+0:10]-[C;+0:4].[O;H1;+0:3]-[C:2](=[O:1])-[N;+0:8](-[#6:7])',
                     '[C;H3;+0:9]-[C;+0:4]-[O;H0;+0:3]-[C:2](=[O;H1;+1:1])-[N;+0:8](-[#6:7])>>[C;H2;+0:9]=[C;+0:4].[O;H0;+0:3]=[C:2](-[O;H1;+0:1])-[N;+0:8](-[#6:7])',
                      '[C;+0:4]-[O;H0;+0:3]-[C:2](=[O;H1;+1:1])-[N;+0:8](-[#6:7]).[Cl,Br,I,O;-1:10]>>[Cl,Br,I,O;+0:10]-[C;+0:4].[O;H0;+0:3]=[C:2](-[O;H1;+0:1])-[N;+0:8](-[#6:7])'],
...
'Reaction with PdX2, PPh3, and water': {'Reagent': ['[Cl,Br,I,O][Pd;+0][Cl,Br,I,O]', '[P]', '[O;H1,H2]'],
 ...
 ('Bromination',): {'Bromination on benzene': {'Reagent': ['O=C-[O;H1+0,H0-]','BrBr', '[c;H1]'],
  ...
  'Bromination of alpha ketone': {'Reagent': ['O=C-[C;!H0]', 'BrBr'],
