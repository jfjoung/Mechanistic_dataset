 ...
 ('N-Boc deprotection',):
  ...
  'Deprotection with Alkali hydroxide': {'Reagent': ['[Li,Na,K][O;H1]'], 'Exclude_reagent': None,
   ...
   'Stages': {0: {'Templates': ['[O;+0:3]-[C:2](=[O;H0;+0:1])-[N;+0:8](-[#6:7]).[Li,Na,K:9][O;H1;+0:5]>>[Li,Na,K;H0;+1:9].[O;+0:3]-[C:2](-[O;H0;-1:1])(-[O;H1;+0:5])-[N;+0:8](-[#6:7])'],
    ...
    1: {'Templates': ['[#6;H3;+0:9]-[#6;+0:4]-[#8;H1;+1:3]-[#6:2](=[#8:1])-[#7;+0:8]>>[#6;H2;+0:9]=[#6;+0:4].[#8;H1;+0:3]-[#6:2](=[#8:1])-[#7;+0:8]',
                      '[#6;+0:4]-[#8;H1;+1:3]-[#6:2](=[#8:1])-[#7;+0:8].[Cl,Br,I,O;-1:10]>>[Cl,Br,I,O;+0:10]-[#6;+0:4].[#8;H1;+0:3]-[#6:2](=[#8:1])-[#7;+0:8]',
                     '[#6;H3;+0:9]-[#6;+0:4]-[#8;H0;+0:3]-[#6:2](=[#8;H1;+1:1])-[#7;+0:8]>>[#6;H2;+0:9]=[#6;+0:4].[#8;H0;+0:3]=[#6:2](-[#8;H1;+0:1])-[#7;+0:8]',
                      '[#6;+0:4]-[#8;H0;+0:3]-[#6:2](=[#8;H1;+1:1])-[#7;+0:8].[Cl,Br,I,O;-1:10]>>[Cl,Br,I,O;+0:10]-[#6;+0:4].[#8;H0;+0:3]=[#6:2](-[#8;H1;+0:1])-[#7;+0:8]'],
     'pKa': [{'B': -30}, None, {'B': -30}, None],
...
('Bromo Suzuki coupling',
  ...
  'Iodo Miyaura boration'):
   ...
   'Stages': {0: {'Templates': ['[Cl,Br,I:7]-[#6;+0:5].[Pd;D0;+0:6]>>[Cl,Br,I:7]-[Pd:6]-[#6;+0:5]'],
    ...
    1: {'Templates': ['[#8;H2:8].[Cl,Br,I:7]-[Pd:6]-[#6;+0:5]>>[Cl,Br,I;H1;+0:7].[#8;H1;+0:8]-[Pd:6]-[#6;+0:5]',
      '[#6:10][#8;H1:8].[Cl,Br,I:7]-[Pd:6]-[#6;+0:5]>>[Cl,Br,I;H1;+0:7].[#6:10][#8;H0;+0:8]-[Pd:6]-[#6;+0:5]',
     ...
     'Reaction with Pd(OR)2 and amine agent': {'Reagent': ['[O][Pd;+0][O]', '[N;+0]-[C;!H0]'], 'Exclude_reagent': None,
                             'Stages': {0: {'Templates': ['[O:2]-[Pd;+0:1]-[O:3].[N;+0:4]-[C;!H0:5]>>[O:2]-[Pd;+0:1]-[N;+1:4]-[C;!H0:5].[O;-1:3]'],
                                 ...
                                 3: {'Templates': ['[Cl,Br,I:7]-[#6;+0:5].[Pd&!$([Pd]-I)&!$([Pd]-Br)&!$([Pd]-Cl):6]>>[Cl,Br,I:7]-[Pd:6]-[#6;+0:5]'],
                                     ...
                                     'Description': 'Oxidative addition'},
                                 4: {'Templates': [
                                     '[#8;H2:8].[Cl,Br,I:7]-[Pd:6]-[#6;+0:5]>>[Cl,Br,I;H1;+0:7].[#8;H1;+0:8]-[Pd:6]-[#6;+0:5]',
                                     '[#6:10][#8;H1:8].[Cl,Br,I:7]-[Pd:6]-[#6;+0:5]>>[Cl,Br,I;H1;+0:7].[#6:10][#8:8]-[Pd:6]-[#6;+0:5]',
                                     '[Li,Na,K,Cs:10][#8:8].[Cl,Br,I:7]-[Pd:6]-[#6;+0:5]>>[Cl,Br,I;-1:7].[Li,Na,K,Cs;+1:10].[#8:8]-[Pd:6]-[#6;+0:5]',
                                     '[#6:9]-[#8;-1:8].[Cl,Br,I:7]-[Pd:6]-[#6;+0:5]>>[Cl,Br,I;-1:7].[#6:9]-[#8;+0:8]-[Pd:6]-[#6;+0:5]'],
                                     'pKa': [None, None, None, None],
...
'Reaction with Pd coordinated with 3 or 4 ligands': {'Reagent': ['[Pd;D3,D4;$([Pd](-[*])(-[*])-[*]),$([Pd](-[*])(-[*])(-[*])-[*]);!$([Pd]([Cl,Br,I,O])[Cl,Br,I,O]);+0]'],
     ...
     'pKa': [None],
     'Description': 'Oxidative addition'},
    3:{'Templates': ['[F,Cl,Br,I:5]-[Pd:1]-[#6:6].[Cu:2]-[#6:3]#[#6:4]>>[F,Cl,Br,I:5]-[Cu:2].[#6:6]-[Pd:1]-[#6:3]#[#6:4]',
                     '[Cl,Br,I:7]-[Pd:6]-[#6;+0:5].[Sn:1]-[#6;$([#6]=,:[#6]):2]>>[#6:2]-[Pd:6]-[#6;+0:5].[Sn:1]-[Cl,Br,I:7]'],
     'pKa': [None, None],
     'Description': 'Transmetalation'},
...
#### TODO: It gives errors only
 ('Wohl-Ziegler bromination',): {'Reaction with radical': {'Reagent': ['[#7,#8;D2]-,=[#7,#8;D2]'], 'Exclude_reagent': None,
   'Stages': {0: {'Templates': ['[#6:1]-[C:2](=[O:3])-[O:4]-[O:5]-[C:6](=[O:7])-[#6:8]>>[#6;H0;+0:1].[#6;H0;+0:8].[O:4]=[C:2]=[O:3].[O:5]=[C:6]=[O:7]',
    ...
    2: {'Templates': ['[Br;v0;H0;+0:1].[C;D1;H3;+0:2]-[#6:3]=[#6:4]>>[Br;H1;+0:1].[C;D1;H2;+0:2]-[#6:3]=[#6:4]',
    ...
    3: {'Templates': ['[Br;v0;H0;+0:1].[C;D1;H2;+0:2]-[#6:3]=[#6:4]>>[Br;H0;+0:1]-[C;H2;+0:2]-[#6:3]=[#6:4]',
  ...
  'Reaction with NBS': {'Reagent': None,  'Exclude_reagent': None,
   'Stages': {0: {'Templates': ['[Br:1][N:2]([C:3]=[O:4])[C:5]=[O:6]>>[Br;H0;+0:1].[N;H0;+0:2]([C:3]=[O:4])[C:5]=[O:6]'],
     'pKa': [None],
     'Description': 'Radical formation'},
    1: {'Templates': ['[Br;H0;+0:1].[C;H3;+0:2]-[#6:3]=[#6:4]>>[Br;H1;+0:1].[C;H2;+0:2]-[#6:3]=[#6:4]',
     ...
     'pKa': [None,
      ...
      None],
     'Description': 'Propagation'},
    2: {'Templates': ['[Br;H0;+0:1].[C;H2;+0:2]-[#6:3]=[#6:4]>>[Br;H0;+0:1]-[C;H2;+0:2]-[#6:3]=[#6:4]',
 ...
 ('Bromo Grignard reaction',
  ...
  'Grignard + acid chloride ketone synthesis'): {'Reaction': {'Reagent': None, 'Exclude_reagent': None,
   'Stages': {0: {'Templates': ['[C:1]=[#8:2].[Cl,Br,I:3]-[Mg:4]-[*:5]>>[#8;-1:2]-[C:1]-[*:5].[Mg;+1:4](-[Cl,Br,I:3])',
    ...
    1: {'Templates': ['[#8;-1:2]-[#6:1]-[*:5]>>[#8;+0:2]=[#6:1].[*;-1:5]',
...
#TODO: It gives no product
 ...
 ('CO2H-Me deprotection',
  ...
  ('O-TBS protection',
   'O-TMS protection',
   'O-TIPS protection',
   'O-TES protection'): {'Reaction': {'Reagent': ['[Si]([C])([C])([C])[Cl,Br,I]'], 'Exclude_reagent': None,
