class Args:
    def __init__(self):
        self.num_combination = 500  # Limits the number of possible reactant combinations per template to prevent combinatorial explosion.
        ...
        self.rxn_class = 'Carboxylic acid to alcohol reduction'  # Specifies a particular reaction class to extract elementary reactions from.
