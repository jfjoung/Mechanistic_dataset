class Args:
    def __init__(self):
        ...
        self.num_reaction_node = 30  # Sets an upper limit on the number of reactions in the reaction network to prevent excessive computation time when converting to elementary reaction SMARTS.
        ...
        self.rxn_class = 'Carboxylic acid + amine condensation' # Specifies a particular reaction class to extract elementary reactions from.
