...
'Condensation using BOP': {'Reagent': ['[#8]=[#6]-[#8]','[#7,#16,#8]', '[#7]-[#8]-[P+]'], 'Exclude_reagent': None,
   ...
   6: {'Templates': ['[#7;+0:21]-[O;H0;+0:20]-[C;H0;+0:14](-[N;H3;+1:8])(-[#6:13])-[O;-1:15]>>[#7;+0:21]-[O;H0;-1:20].[N;H3;+1:8]-[C;H0;+0:14](-[#6:13])=[O;+0:15]',
    ...
    'Stages':{ 0: {'Templates': ['[O;H1;+0:1]-[C;H0;+0:14](-[#6:13])=[O:15]>>[O;H0;-1:1]-[C;H0;+0:14](-[#6:13])=[O:15]',],
              ...
              2:{'Templates':['[O;H0;-1:5]-[P:6](=[O:7])(-[#6:8])-[O:9]-[P:10](=[O:11])(-[#6:12])-[O:13]-[P:14](=[O:15])(-[#6:16])([O;H0;+0:1]-[C;H0;+0:2](-[#6:3])=[O:4]).[N;H3;+0:17]>>[O;H0;-1:5]-[P:6](=[O:7])(-[#6:8])-[O:9]-[P:10](=[O:11])(-[#6:12])-[O:13]-[P:14](=[O:15])(-[#6:16])-[O;H0;-1:1].[C;H0;+0:2](-[#6:3])(=[O:4])-[N;H3;+1:17]',
              '[O;H0;-1:5]-[P:6](=[O:7])(-[#6:8])-[O:9]-[P:10](=[O:11])(-[#6:12])-[O:13]-[P:14](=[O:15])(-[#6:16])([O;H0;+0:1]-[C;H0;+0:2](-[#6:3])=[O:4]).[N;H2;+0:17]-[*:18]>>[O;H0;-1:5]-[P:6](=[O:7])(-[#6:8])-[O:9]-[P:10](=[O:11])(-[#6:12])-[O:13]-[P:14](=[O:15])(-[#6:16])-[O;H0;-1:1].[C;H0;+0:2](-[#6:3])(=[O:4])-[N;H2;+1:17]-[*:18]',
              '[O;H0;-1:5]-[P:6](=[O:7])(-[#6:8])-[O:9]-[P:10](=[O:11])(-[#6:12])-[O:13]-[P:14](=[O:15])(-[#6:16])([O;H0;+0:1]-[C;H0;+0:2](-[#6:3])=[O:4]).[N;H1;+0:17]-[*:18]>>[O;H0;-1:5]-[P:6](=[O:7])(-[#6:8])-[O:9]-[P:10](=[O:11])(-[#6:12])-[O:13]-[P:14](=[O:15])(-[#6:16])-[O;H0;-1:1].[C;H0;+0:2](-[#6:3])(=[O:4])-[N;H1;+1:17]-[*:18]',
              '[O;H0;-1:5]-[P:6](=[O:7])(-[#6:8])-[O:9]-[P:10](=[O:11])(-[#6:12])-[O:13]-[P:14](=[O:15])(-[#6:16])([O;H0;+0:1]-[C;H0;+0:2](-[#6:3])=[O:4]).[S,O;H1;+0:8]-[*:18]>>[O;H0;-1:5]-[P:6](=[O:7])(-[#6:8])-[O:9]-[P:10](=[O:11])(-[#6:12])-[O:13]-[P:14](=[O:15])(-[#6:16])-[O;H0;-1:1].[C;H0;+0:2](-[#6:3])(=[O:4])-[S,O;H1;+1:8]-[*:18]',],
                  'pKa':[None, None, None, None],
                  'Description':'Nucleophilic addition'},
              3:{'Templates':['[C;H0;+0:2](-[#6:3])(=[O:4])-[N;H3;+1:17]>>[C;H0;+0:2](-[#6:3])(=[O:4])-[N;H2;+0:17]',
