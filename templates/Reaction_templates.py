 ...
 'Claisen-Schmidt condensation',
  'Aldol condensation',): {'Basic condition': {'Reagent': ['[O]=[C]-[C]','[C]=[O]',], 'Exclude_reagent': None,
   'Stages': {0: {'Templates': ['[#8:1]=[#6:2]-[#6;H2:3]-[#6:4]=[#8:5]>>[#8;-1:1]-[#6:2]=[#6;H1;+0:3]-[#6:4]=[#8:5]',
    ...
    4: {'Templates': ['[#8;-1:1]-[#6:2]=[#6;H0;+0:3]-[#6:4]-[#8;H1;+0:5]>>[#8:1]=[#6:2][#6;H0;+0:3]=[#6:4].[#8;H1;-1:5]',
                      '[#8;-1:1]-[#6:2]=[#6;H0;+0:3](-[#6:4]-[#8;H1;+0:5])-[#6:6]=[#8:7]>>[#8:1]=[#6:2][#6;H0;+0:3](=[#6:4])-[#6:6]=[#8:7].[#8;H1;-1:5]',
                      '[#8;-1:1]-[#6:2]=[#6;H1;+0:3]-[#6:4]-[#8;H1;+0:5]>>[#8:1]=[#6:2][#6;H1;+0:3]=[#6:4].[#8;H1;-1:5]',
                      '[#8;-1:1]-[#6:2]=[#6;H1;+0:3](-[#6:4]-[#8;H1;+0:5])-[#6:6]=[#8:7]>>[#8:1]=[#6:2][#6;H1;+0:3](=[#6:4])-[#6:6]=[#8:7].[#8;H1;-1:5]',
