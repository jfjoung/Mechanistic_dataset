...
'Reaction with PdX2, PPh3, and water': {'Reagent': ['[Cl,Br,I,O][Pd;+0][Cl,Br,I,O]', '[P]', '[O;H1,H2]',], 'Exclude_reagent': None,
 ...
 ('O-Bn deprotection',
  'N-Bn deprotection',): {'Pd with H2': {'Reagent': ['[Pd;+0]', '[H]-[H]','[#7,#8]-[C]-[c]',], 'Exclude_reagent': None,
   'Stages': {0: {'Templates': ['[Pd;+0:1].[*:2]-[O:3]-[#6:4]>>[*:2]-[O:3]-[Pd;+0:1]-[#6:4]',
    ...
    1: {'Templates': ['[*:2]-[O;H0:3]-[Pd;+0:1]-[#6;H2:4].[H:5][H:6]>>[*:2]-[O;H0:3]-[H:5].[H:6]-[#6;H2:4].[Pd;+0:1]',
                      '[*:2]-[#7;H0:3]-[Pd;+0:1]-[#6;H2:4].[H:5][H:6]>>[*:2]-[#7;H0:3]-[H:5].[H:6]-[#6;H2:4].[Pd;+0:1]',
                      '[*:2]-[#7;H1:3]-[Pd;+0:1]-[#6;H2:4].[H:5][H:6]>>[*:2]-[#7;H1:3]-[H:5].[H:6]-[#6;H2:4].[Pd;+0:1]',],
     'pKa': [None, None, None],
 ...
 ('N-Cbz deprotection',): {'Strong acid': {'Reagent': ['[Cl,Br,I;D0]','[N]-[C](=[O])-[O]',], 'Exclude_reagent': None,
   'Stages': {0: {'Templates': ['[O;H0:1]=[C:2]-[O:3].[Cl,Br,I;H1;+0:4]>>[O;H1;+1:1]=[C:2]-[O:3].[Cl,Br,I;H0;-1:4]',],
     'pKa': [None],
     'Description': 'Proton exchange'},
...
('Carboxylic acid to alcohol reduction',):{'Borane/THF':{'Reagent':['[O]=[C]-[O]','[B]',],'Exclude_reagent':None,
                                          'Stages':{
                                            0:{'Templates':['[O:1]=[C:2]-[O;H1:3].[B;H3:4]>>[B;H3;-1:4]-[O;+1:1]=[C:2]-[O;H1:3]',],
                                                       'pKa':[None],
                                                       'Description':'First coordination'},
                                            1:{'Templates':['[B;H3;-1:4]-[O;+1:1]=[C:2]-[O;H1:3].[B;+0;H3:5]>>[B;H3;-1:4]-[O;+1:1]=[C:2]-[O;H1;+1:3]-[B;H3;-1:5]',],
                                                       'pKa':[None],
                                                       'Description':'Second coordination'},
                                            2:{'Templates':['[B;-1:4](-[#1:6])-[O;+1:1]=[C:2]-[O;+1:3](-[#1:7])-[B;H3;-1:5]>>[#1:6]-[#1:7].[B;-1:4]=[O;+1:1]-[C:2]=[O;+1:3]-[B;H3;-1:5]',],
                                                       'pKa':[None],
                                                       'Description':'Deprotonation'},
                                            ...
                                            7:{'Templates':['[C:1](-[#1:2])-[O;+0:3]-[B;+0:4].[O;H2;+0:5]>>[C:1](-[#1:2])-[O;+0;H1:3].[B;+0:4]-[O;H1;+0:5]',
                                              ...
                                              # 0:{'Templates':['[O:1]=[C:2]-[O:3]-[H:5].[B;H2:4]-[H:6]>>[O:1]=[C:2]-[O;H0;+0:3]-[B;H2;+0:4].[H:5]-[H:6]',],
                                              #          'pKa':[None],
                                          ...
                                          # 'BF3/NaBH4':{'Reagent':['[B;H4;-1]','[O]=[C]-[O]','[F]-[B](-[F])-[F]',],'Exclude_reagent':None, #TODO: Don't understand what is the mechanism here
                                          # 'Stages':{0:{'Templates':['[B;H4;-1:8].[F:4]-[B;H0:5](-[F:6])-[F:7]>>[F:4]-[B;H1;-1:5](-[F:6])(-[F:7]).[B;H3;+0:8]',],
                                          #              'pKa':[None],
                                          #              'Description':'Formation of BH3'},
                                          #           1:{'Templates':['[O:1]=[C:2]-[O;H1:3].[B;H3:4]>>[O:1]=[C:2]-[O;H0;+0:3]-[B;H2;+0:4]',],
                                          #              'pKa':[None],
                                          #              'Description':'Formation of acyl borate'},
                                          #           2:{'Templates':['[O:1]=[C:2]-[O;H0;+0:3]-[B;H2;+0:4].[B;H4;-1:9].[F:10]-[B;H0:11](-[F:12])-[F:13]>>[O:1]=[C:2]-[O;H0;+0:3]-[B;H2;+0:4].[F:10]-[B;H1;-1:11](-[F:12])(-[F:13]).[B;H3;+0:9]',],
                                          #              'pKa':[None],
                                          #              'Description':'Formation of BH3'},
                                          #           3:{'Templates':['[O;H0:1]=[C:2]-[O;H0;+0:3]-[B;H2;+0:4].[B;H3:9]>>[B;H3;-1:9]-[O;H0;+0:1]-[C:2]=[O;H0;+1:3]-[B;H2;+0:4]',],
                                          #              'pKa':[None],
                                          #              'Description':'Addition of another borane'},
                                          #           4:{'Templates':['[B;H3;-1:9]-[O;H0;+0:1]-[C;H0:2]=[O;H0;+1:3]-[B;H2;+0:4]>>[B;H2;+0:9]-[O;H0;+0:1]-[C;H1:2]-[O;H0;+0:3]-[B;H2;+0:4]',],
                                          #              'pKa':[None],
                                          #              'Description':'First addition of hydride'},
