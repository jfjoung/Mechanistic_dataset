...
'Condensation using BOP': {'Reagent': ['[#8]=[#6]-[#8]','[#7,#16,#8]', '[#7]-[O]-[P+]'], 'Exclude_reagent': None,
  ...
  'Condensation without catalyst': {'Reagent': ['[#8]-[#6]=[#8]','[#7,#16,#8]',], 'Exclude_reagent': ['[N]=[C]=[N]','[#7;+1]=[#6](-[*])-[#7]', '[n]-[C](=[O])-[n]', '[#7]-[O]-[P+]'],
...
'Reaction with PdX2, PPh3, and water': {'Reagent': ['[Cl,Br,I,O][Pd;+0][Cl,Br,I,O]', '[P]', '[O;H1,H2]',], 'Exclude_reagent': None,
   'Stages': {
    ...
    6: {'Templates': ['[Cl,Br,I,O:2]-[Pd;H1;+0:1]>>[Cl,Br,I,O;H1:2].[Pd;H0;+0:1]',],
     ...
     7: {'Templates': ['[P;H0;+0:1].[Pd;D0;+0:6]>>[P;H0;+0:1]-[Pd;D1;+0:6]',],
     'pKa': [None],
     'Description': 'First Pd-P ligand formation'},

    8: {'Templates': ['[P;H0;+0:2].[P;H0;+0:1]-[Pd;D1;+0:6]>>[P;H0;+0:2]-[Pd;D2;+0:6]-[P;H0;+0:1]',],
     'pKa': [None],
     'Description': 'Second Pd-P ligand formation'},
...
('Nazarov cyclization',): {'Reaction': {'Reagent': ['[Al]','[#6]=[#6]-[#6]=[#8]'], 'Exclude_reagent': None,
   'Stages': {0: {'Templates':['[Al,Fe;+3:1].[Cl;-1:2].[Cl;-1:3].[Cl;-1:4]>>[Al,Fe;+0:1](-[Cl;+0:2])(-[Cl;+0:3])-[Cl;+0:4]',],  #added this because all of the templates seemed to have AlCl3 ionically written
    ...
    '[#6;H2:7]1-[#6;+1:8]-[#6:5](-[#8;+0:6])=[#6:9]-[#6:10]1.[Cl;-1;H1:11]>>[#6;H0:7]1=[#6;+0:8]-[#6:5](-[#8;+0:6])=[#6:9]-[#6:10]1.[Cl;+0;H1:11]'], 
                  'pKa':[None,None],
                  'Description':'Deprotonation'},
