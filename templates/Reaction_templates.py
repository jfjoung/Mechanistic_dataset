 ...
 ('CO2H-Me deprotection',
  ...
  ('O-TBS protection',
   ...
   'Iodo thioether synthesis',): {'Alkyl carbon': {'Reagent':['[S]','[F,Cl,Br,I]-[C]'], 'Exclude_reagent': None,
     'Stages':{0: {'Templates': ['[S;H1;+0:1].[C:2]-[F,Cl,Br,I:3]>>[S;H0;-1:1].[C:2]-[F,Cl,Br,I:3]'],
      'pKa' : [{'B':10}],
      'Description' : 'Deprotonation'},
      1: {'Templates' : ['[S;H0;-1:1].[C:2]-[F,Cl,Br,I:3]>>[S;H0;+0:1]-[C:2]'],
      'pKa': [None],
      'Description':'Substitution'}}},
      ...
      'pKa' : [{'B':10}],
      'Description': 'Deprotonation'},
      2: {'Templates': ['[S;H0;-1:1].[F,Cl,Br,I:3]-[c:2]:[a:4]>>[S;H0;+0:1]-[c:2](-[F,Cl,Br,I:3])-[a;-1:4]'],
          'pKa' : [None],
          'Description': 'Nucleophilic Addition'},
      3: {'Templates': ['[S;H0;+0:1]-[c:2](-[F,Cl,Br,I:3])-[a;-1:4]>>[S;H0;+0:1]-[c:2]:[a;+0:4].[F,Cl,Br,I;-1:3]'],
          'pKa':[None],
...
('Azido to amino',):{'Direct Hydrogenation':{'Reagent':['[#6]-[N]=[N;+1]=[N;-1]','[H]-[H]'],'Exclude_reagent':None,
                    'Stages':{0:{'Templates':['[#6:1]-[N:2]=[N;+1:3]=[N;-1:4].[H]-[H]>>[#6:1]-[N;H1;+0:2]-[N;H1;+1:3]=[N;H0;-1:4]'],
                                 'pKa':[None],
                                 'Description':'Addition of H2'},
                              1:{'Templates':['[#6:1]-[N;H1;+0:2]-[N;H1;+1:3]=[N;H0;-1:4]>>[#6:1]-[N;H2;+1:2]-[N;H0;+0:3]=[N;H0;-1:4]'],
                                 'pKa':[None],
                                 'Description':'Proton transfer'},
                              2:{'Templates':['[#6:1]-[N;H2;+1:2]-[N;H0;+0:3]=[N;H0;-1:4]>>[#6:1]-[N;H2+0:2].[N;H0:3]#[N;H0;+0:4]'],
                                 'pKa':[None],
 ...
 ('Ethyl esterification',): {'Acid-catalyzed': {'Reagent': ['[C]-[C]-[O]','[O]=[C]-[O]'], 'Exclude_reagent': None,
   'Stages': {0: {'Templates':['[O:1]=[C:2]-[O:3]>>[O;H1;+1:1]=[C:2]-[O:3]'],
              ...
              1:{'Templates':['[O;H1;+1:1]=[C:2]-[O:3].[C;H3:4]-[C;H2:5]-[O;H1:6]>>[O;H1;+0:1]-[C:2](-[O:3])-[O;H1;+1:6]-[C;H2:5]-[C;H3:4]'],
                 'pKa':[None],
                 'Description':'Nucleophilic addition'},
              2:{'Templates':['[O;H1;+0:1]-[C:2](-[O:3])-[O;H1;+1:6]-[C;H2:5]-[C;H3:4]>>[O;H1;+0:1]-[C:2](-[O;H1;+1:3])-[O;H0;+0:6]-[C;H2:5]-[C;H3:4]'],
                 'pKa':[None],
                 'Description':'Proton transfer'},
              3:{'Templates':['[O;H1;+0:1]-[C:2](-[O;H1;+1:3])-[O;H0;+0:6]-[C;H2:5]-[C;H3:4]>>[O;H1;+1:1]=[C:2]-[O;H0;+0:6]-[C;H2:5]-[C;H3:4].[O;H1;+0:3]'],
                  'pKa':[None],
                  'Description':'Tetrahedral intermediate collapse'},
  ...
  'Base-catalyzed':{'Reagent':['[C]-[C]-[O]','[O]=[C]-[O]'],'Exclude_reagent':None,
    'Stages':{0:{'Templates':['[C;H3:4]-[C;H2:5]-[O;H1;+0:6]>>[C;H3:4]-[C;H2:5]-[O;H0;-1:6]'],
                 'pKa':[{'B':16}],
                 'Description':'Deprotonation'},
              1:{'Templates':['[O:1]=[C:2]-[O:3].[C;H3:4]-[C;H2:5]-[O;H0;-1:6]>>[O;H0;-1:1]-[C:2](-[O:3])-[O;H0;+0:6]-[C;H2:5]-[C;H3:4]'],
                 'pKa':[None],
                 'Description':'Nucleophilic addition'},
              2:{'Templates':['[O;H0;-1:1]-[C:2](-[O:3])-[O;H0;+0:6]-[C;H2:5]-[C;H3:4]>>[O;H0;+0:1]=[C:2]-[O;H0;+0:6]-[C;H2:5]-[C;H3:4]'],
                 'pKa':[None],
                 'Description':'Tetrahedral intermediate collapse'}}},
...
('Carboxy ester to carbamoyl',):{'Reaction':{'Reagent':['[N]','[O]=[C]-[O]-[#6]'],'Exclude_reagent':None,
            'Stages':{0:{'Templates':['[O:1]=[C:2]-[O:3]-[#6:4].[N:5]>>[N;H3;+1:5]-[C:2](-[O;H0;-1:1])-[O:3]-[#6:4]'],
                         'pKa':[None],
                         'Description':'Nucleophilic addition'},
...
('Carboxylic acid to alcohol reduction',):{'Borane/THF':{'Reagent':['[O]=[C]-[O]','[B]'],'Exclude_reagent':None,
                                          'Stages':{0:{'Templates':['[O:1]=[C:2]-[O;H1:3].[B;H3:4]>>[O:1]=[C:2]-[O;H0;+0:3]-[B;H2;+0:4]'],
                                                       'pKa':[None],
                                          ...
                                          'Stages':{0:{'Templates':['[B;H4;-1:8].[F:4]-[B:5](-[F:6])-[F:7]>>[F:4]-[B;H1;-1:5](-[F:6])(-[F:7]).[B;H3;+0:8]'],
                                                    ...
                                                    8:{'Templates':['[C;H2:2]-[O;H0;+0:3]-[B;H1;+0:4]-[O;H0;+0:1]-[B;H2;+0:9].[O;H2:6]>>[C;H2:2]-[O;H1;+0:3].[O;H1;+0:6]-[B;H1;+0:4]-[O;H0;+0:1]-[B;H2;+0:9]',
                                                        ...
                                                        'pKa':[None, None],
                                                        'Description':'Hydrolysis'},}},
                                            'LAH':{'Reagent':['[O]=[C]-[O]'],'Exclude_reagent':None,
...
('Aldehyde Swern oxidation',
 'Ketone Swern oxidation',):{'Reaction':{'Reagent':['[O]','[O]=[S](-[C])-[C]','[Cl]-[C](=[O])-[C](=[O])-[Cl]'],'Exclude_reagent':None,
                                        'Stages':{0:{'Templates':['[O:1]=[S:2](-[C;H3:3])-[C;H3:4].[Cl:5]-[C:6](=[O:7])-[C:8](=[O:9])-[Cl:10]>>[Cl:5]-[C:6](-[O;H0;+0:1]-[S;H0;+1:2](-[C;H3:3])-[C;H3:4])(-[O;H0;-1:7])-[C:8](=[O:9])-[Cl:10]'],
                                                ...
                                                3:{'Templates':['[Cl;H0;+0:5]-[S;H0;+1:2](-[C;H3:3])-[C;H3:4].[O;H1;+0:11]-[C;H2:12].[Cl;H0;-1:10]>>[Cl;H1;+0:10].[Cl;H0;-1:5].[S;H0;+1:2](-[C;H3:3])(-[C;H3:4])-[O;H0;+0:11]-[C;H2:12]',
                                                                '[Cl;H0;+0:5]-[S;H0;+1:2](-[C;H3:3])-[C;H3:4].[O;H1;+0:11]-[C;H1:12].[Cl;H0;-1:10]>>[Cl;H1;+0:10].[Cl;H0;-1:5].[S;H0;+1:2](-[C;H3:3])(-[C;H3:4])-[O;H0;+0:11]-[C;H1:12]'],
                                                   'pKa':[None,None],
...
('Amide hydrolysis'):{'Base-catalyzed':{'Reagent':['[O]=[C]-[N]'],'Exclude_reagent':None,
                                        'Stages':{0:{'Templates':['[O:1]=[C:2]-[N;H2:3].[O;H1;-1:4]>>[O;H0;-1:1]-[C:2](-[O;H1;+0:4])-[N;H2;+0:3]',
                                                ...
                                                1:{'Templates':['[O;H0;-1:1]-[C:2](-[O;H1;+0:4])-[N;H2;+0:3]>>[O;H0;-1:1]=[C:2](-[O;H1;+0:4]).[N;H2;-1:3]',
                                                   ...
                                                   'pKa':[None,None,None],
                                                   'Description':'Tetrahedral intermediate collapse'},
                                                2:{'Templates':['[O;H0;-1:1]=[C:2](-[O;H1;+0:4]).[N;H2;-1:3]>>[O;H0;-1:1]=[C:2](-[O;H1;+0:4]).[N;H3;+0:3]',
                                                               '[O;H0;-1:1]=[C:2](-[O;H1;+0:4]).[N;H1;-1:3]>>[O;H0;-1:1]=[C:2](-[O;H1;+0:4]).[N;H2;+0:3]',
                                                               '[O;H0;-1:1]=[C:2](-[O;H1;+0:4]).[N;H0;-1:3]>>[O;H0;-1:1]=[C:2](-[O;H1;+0:4]).[N;H1;+0:3]'],
                                                   'pKa':[{'A':35},{'A':35},{'A':35}],
                                                   'Description':'Proton transfer'}}},
