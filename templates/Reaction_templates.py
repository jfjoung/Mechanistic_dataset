...
'Triflyloxy N-arylation'): {'Reaction': {'Reagent':['[c]-[F,Cl,Br,I,O]','[#7]',],'Exclude_reagent':None,
      'Stages':{0:{'Templates': ['[N;H1:1].[F,Cl,Br,I,O:3]-[c:2]:[a:4]>>[N;H1;+1:1]-[c:2](-[F,Cl,Br,I,O:3])-[a;-1:4]',
          ...
          'pKa' : [None],
          'Description': 'Nucleophilic Addition'},
      1: {'Templates': ['[N;H1;+1:1]-[c:2](-[F,Cl,Br,I,O:3])-[a;-1:4]>>[N;H1;+1:1]-[c:2]:[a;+0:4].[F,Cl,Br,I,O;-1:3]',
                        '[N;H2;+1:1]-[c:2](-[F,Cl,Br,I,O:3])-[a;-1:4]>>[N;H2;+1:1]-[c:2]:[a;+0:4].[F,Cl,Br,I,O;-1:3]',],
          'pKa':[None],
          'Description': 'Elimination'},
      2:{'Templates':['[N;H1;+1:1]-[c:2]:[a;+0:4].[F,Cl,Br,I,O;-1:3]>>[N;H0;+0:1]-[c:2]:[a;+0:4].[F,Cl,Br,I,O;H1;+0:3]',
                      '[N;H2;+1:1]-[c:2]:[a;+0:4].[F,Cl,Br,I,O;-1:3]>>[N;H1;+0:1]-[c:2]:[a;+0:4].[F,Cl,Br,I,O;H1;+0:3]',
                      '[N;H1;+1:1]-[c:2]:[a;+0:4]>>[N;H0;+0:1]-[c:2]:[a;+0:4]',
                      '[N;H2;+1:1]-[c:2]:[a;+0:4]>>[N;H1;+0:1]-[c:2]:[a;+0:4]',],
                      'pKa':[None, None, {'B': 4.63}, {'B': 4.63}],
                      'Description':'Proton transfer'}
      }},
      },
