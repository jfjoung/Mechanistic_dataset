 ...
 ('Hydroxy to chloro',): {'SOCl2 or POCl3': {'Reagent': ['O=[S,P](-[Cl])-[Cl]','[O]',], 'Exclude_reagent': None,
   'Stages': {0: {'Templates': ['[O;H1;+0:1]>>[O;H0;-1:1]',],
    ...
    3: {'Templates': ['[*:5]-[O;H0;+0:1]-[S,P;+0:3](-[Cl;+0:6])=[O;+0:2].[Cl;-1:4]>>[*:5]-[Cl;+0:4].[O;H0;+0:1]=[S,P;+0:3]=[O;+0:2].[Cl;-1:6]',
                      '[*:5]-[O;H1;+1:1]-[S,P;+0:3](-[Cl;+0:6])=[O;+0:2].[Cl;-1:4]>>[*:5]-[Cl;+0:4].[O;H1;+1:1]=[S,P;+0:3]=[O;+0:2].[Cl;-1:6]',
                      '[*:5]-[O;H0;+0:1]-[S,P;!$([S,P]~[Cl]);+0:3](=[O;+0:6])=[O;+0:2].[Cl;-1:4]>>[*:5]-[Cl;+0:4].[O;H0;-1:1]-[S,P;+0:3](=[O;+0:6])=[O;+0:2]',
                      '[*:5]-[O;H1;+1:1]-[S,P;!$([S,P]~[Cl]);+0:3](=[O;+0:6])=[O;+0:2].[Cl;-1:4]>>[*:5]-[Cl;+0:4].[O;H1;+1:1]=[S,P;+0:3](=[O;+0:6])=[O;+0:2]',],
     'pKa': [None, None],
     'Description': 'Nucleophilic substitution'},
    4: {'Templates': ['[O;H1;+1:1]=[S,P;+0:3]=[O;+0:2].[Cl;H0;-1:6]>>[O;H0;+0:1]=[S,P;+0:3]=[O;+0:2].[Cl;H1;+0:6]',],
     'pKa': [None,],
     'Description': 'Deprotonation'}}},
