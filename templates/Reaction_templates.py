  ...
  'React with SOCl2 or POCl3': {'Reagent': ['O=[S,P]-[Cl]','[#6]-[O]','[N]',], 'Exclude_reagent': None,
   'Stages': {0: {'Templates': ['[O;H1;+0:1]>>[O;H0;-1:1]',],
    ...
    3: {'Templates': ['[*:5]-[O;H0;+0:1]-[S,P;+0;!$([S,P]~Cl):3]-[#6;+0:6].[#7;H3;+0:4]>>[#7;H3;+1:4]-[*:5].[O;H0;-1:1]-[S,P;+0;!$([S,P]~Cl):3]-[#6;+0:6]',
                      ...
                      '[*:5]-[O;H0;+0:1]-[S,P;+0:3](-[Cl;+0:6])(=[O;+0:4])=[O;+0:2].[#7;H3;+0:4]>>[#7;H3;+1:4]-[*:5].[O;H0;+0:1]=[S,P;+0:3](=[O;+0:4])=[O;+0:2].[Cl;-1:6]',
                     '[*:5]-[O;H0;+0:1]-[S,P;+0:3](-[Cl;+0:6])(=[O;+0:4])=[O;+0:2].[#7;H2;+0:4]>>[#7;H2;+1:4]-[*:5].[O;H0;+0:1]=[S,P;+0:3](=[O;+0:4])=[O;+0:2].[Cl;-1:6]',
                     '[*:5]-[O;H0;+0:1]-[S,P;+0:3](-[Cl;+0:6])(=[O;+0:4])=[O;+0:2].[#7;H1;+0:4]>>[#7;H1;+1:4]-[*:5].[O;H0;+0:1]=[S,P;+0:3](=[O;+0:4])=[O;+0:2].[Cl;-1:6]',],
     'pKa': [None,None,None,None,None,None],
     'Description': 'Nucleophilic substitution'},
