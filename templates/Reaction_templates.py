...
'Condensation using CDI': {'Reagent': ['[#8]=[#6]-[#8]','[#7,#16,#8]', '[#7]-[#6](=[#8])-[#7]'], 'Exclude_reagent': None,
   'Stages': {
    ...
    1: {'Templates': ['[O;H0;-1:1]-[C;H0;+0:2](-[#6:3])=[O:4].[O:5]=[C:6][N:7]1[C:8]=[N;H1;+1:9][C:10]=[C:11]1>>[O;-1:5]-[C:6](-[O;H0;+0:1]-[C;H0;+0:2](-[#6:3])=[O:4])-[N:7]1=[C:8]-[N;H1;+0:9][C:10]=[C:11]1',
    ],
     'pKa': [None],
     'Description': 'Reaction of carboxylic acid and CDI'},

    2: {'Templates': ['[O;-1:5]-[C:6](-[O;H0;+0:1]-[C;H0;+0:2](-[#6:3])=[O:4])-[N:7]1=[C:8]-[N;H1;+0:9][C:10]=[C:11]1>>[O:5]=[C:6]-[O;H0;+0:1]-[C;H0;+0:2](-[#6:3])=[O:4].[N:7]1=[C:8]-[N;H1;+0:9][C:10]=[C:11]1',
    ],
     'pKa': [None],
   ...
   4: {'Templates': ['[O;-1:1]-[C:2](-[N;+1:11]1=[C:12]-[N;H1;+0:13][C:14]=[C:15])[O:3][C:4](=[O:10])([N:5]1[C:6]=[C:7][N:8]=[C:9]1)>>[O:1]=[C:2]-[N:11]1-[C:12]=[N;H0;+0:13][C:14]=[C:15]1.[O:3]=[C:4]=[O:10].[N;H1;+0:5]1[C:6]=[C:7][N:8]=[C:9]1'],
      'pKa': [None],
      'Description': 'Addition of imidazole into carboxylic acid-CDI'},
    ...
    6: {'Templates': ['[N;H3;+1:9]-[C:2]-[O;-1:1]-[N;+0:3]1-[C:4]=[N:5][C:6]=[C:7]1>>[N;H3;+1:9]-[C:2]=[O:1].[N;-1:3]1-[C:4]=[N:5][C:6]=[C:7]1',
        '[*:8]-[N;H2;+1:9]-[C:2]-[O;-1:1]-[N;+0:3]1-[C:4]=[N:5][C:6]=[C:7]1>>[*:8]-[N;H2;+1:9]-[C:2]=[O:1].[N;-1:3]1-[C:4]=[N:5][C:6]=[C:7]1',
      '[*:8]-[N;H1;+1:9]-[C:2]-[O;-1:1]-[N;+0:3]1-[C:4]=[N:5][C:6]=[C:7]1>>[*:8]-[N;H1;+1:9]-[C:2]=[O:1].[N;-1:3]1-[C:4]=[N:5][C:6]=[C:7]1',
      '[*:8]-[S,O;H1;+1:9]-[C:2]-[O;-1:1]-[N;+0:3]1-[C:4]=[N:5][C:6]=[C:7]1>>[*:8]-[S,O;H1;+1:9]-[C:2]=[O:1].[N;-1:3]1-[C:4]=[N:5][C:6]=[C:7]1',],
     'pKa': [None, None, None, None],
