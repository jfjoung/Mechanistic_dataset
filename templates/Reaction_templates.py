...
('Carboxylic acid to alcohol reduction',):{'Borane/THF':{'Reagent':['[O]=[C]-[O]','[B]',],'Exclude_reagent':None,
                                          ...
                                          #               'Description':'Hydrolysis'},}},
                                            ...
                                            'Stages':{0:{'Templates':['[Al;H0;+3:1].[#1;D0;-1:2].[#1;D0;-1:3].[#1;D0;-1:4].[#1;D0;-1:5]>>[Al;H0;-1:1](-[#1;D0;+0:2])(-[#1;D0;+0:3])(-[#1;D0;+0:4])(-[#1;D0;+0:5])',],
                                                      ...
                                                      1:{'Templates':['[O:6]=[C:7]-[O:8]-[#1;+0:2].[Al;H3;-1:1]-[#1;+0:3]>>[O:6]=[C:7]-[O;H0;-1:8].[Al;H3;+0:1].[#1;+0:2]-[#1;+0:3]',],
                                                         'pKa':[None],
                                                         'Description':'Acid-base reaction'},
                                                      2:{'Templates':['[O;H0:6]=[C;H0:7]-[O;H0;-1:8].[Al;H3;+0:1]>>[Al;H2;+0:1]-[O;H0;+0:6]-[C;H1:7]-[O;H0;-1:8]',],
                                                         'pKa':[None],
                                                         'Description':'First addition of hydride'},
                                                      3:{'Templates':['[Al;H2;+0:1]-[O;H0;+0:6]-[C;H1:7]-[O;H0;-1:8]>>[O;H0;+0:8]=[C;H1:7].[O;H0;-1:6]-[Al;H2;+0:1]',],
                                                         'pKa':[None],
                                                         'Description':'Formation of aldehyde'},
                                                      4:{'Templates':['[Al;H0;+3:1].[#1;D0;-1:2].[#1;D0;-1:3].[#1;D0;-1:4].[#1;D0;-1:5]>>[Al;H0;-1:1](-[#1;D0;+0:2])(-[#1;D0;+0:3])(-[#1;D0;+0:4])(-[#1;D0;+0:5])',],
                                                        'pKa':[None],
                                                        'Description':'Interconversion between ionic and covalent forms'},
