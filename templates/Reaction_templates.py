...
'Reaction with PdX2, PPh3, and water': {'Reagent': ['[Cl,Br,I,O][Pd;+0][Cl,Br,I,O]', '[P]', '[O;H1,H2]',], 'Exclude_reagent': None,
 ...
 ('Friedel-Crafts acylation',): {'Reaction': {'Reagent': ['[Al,Fe]','[O]=[C]-[Cl]',], 'Exclude_reagent': None,
   'Stages': {0: {'Templates':['[Al,Fe;+3:1].[Cl;-1:2].[Cl;-1:3].[Cl;-1:4]>>[Al,Fe:1](-[Cl:2])(-[Cl:3])-[Cl:4]',],  #added this because all of the templates seemed to have AlCl3 ionically written
                  'pKa':[None],
                  'Description':'Interconversion between ionic and covalent form'},
              1: {'Templates': ['[Al,Fe:1](-[Cl:2])(-[Cl:3])-[Cl:4].[Cl:5]-[C:6]=[O:7]>>[O:7]=[C:6]-[Cl;+1:5]-[Al,Fe;-1:1](-[Cl:2])(-[Cl:3])-[Cl:4]',],
                 'pKa': [None],
                 'Description': 'Lewis acid activation'},
    2: {'Templates': ['[O:7]=[C:6]-[Cl;+1:5]-[Al,Fe;-1:1](-[Cl:2])(-[Cl:3])-[Cl:4]>>[O:7]=[C;+1:6].[Cl;+0:5]-[Al,Fe;-1:1](-[Cl:2])(-[Cl:3])-[Cl:4]',],
        'pKa': [None],
        'Description': 'AlCl4 leaves'},
    3: {'Templates': ['[O:7]=[C;+1:6].[a;+0:8]:[c;H1;+0:9]>>[a;+1:8]-[c;H1;+0:9]-[C;+0:6]=[O:7]',],
     'pKa': [None],
     'Description': 'Addition to aromatic ring'},
    4: {'Templates': ['[a;+1:8]-[c;H1;+0:9]-[C;+0:6]=[O:7].[Cl;+0:5]-[Al,Fe;-1:1]([Cl;+0:2])([Cl;+0:3])-[Cl;+0:4]>>[a;+0:8]:[c;H0;+0:9]-[C;+0:6]=[O:7].[Cl;H1;+0:5].[Al,Fe;+0:1]([Cl:2])([Cl:3])-[Cl:4]',],
     'pKa': [None],
     'Description': 'Proton exchange'}}}},
...
#### TODO: Chem.MolFromSmarts('[Br:1]') generates implicit hydrogen.
 ...
 ('Aldehyde Dess-Martin oxidation',
  'Ketone Dess-Martin oxidation',): {'Reaction': {'Reagent': ['[C]-[O]','[#6]-[I](-[O])-[O]',], 'Exclude_reagent': None,
   'Stages': {0: {'Templates': ['[#8;H1:1]-[#6:2].[#8:3]=[#6:4]1[#6:5][#6:6][I:7]([#8:8][#6:9]([#6:10])=[#8:11])[#8:12]1>>[#8:3]=[#6:4]1[#6:5][#6:6][I:7]([#8;H1;+1:1]-[#6:2])[#8:12]1.[#8;-1:8][#6:9]([#6:10])=[#8:11]',],
     'pKa': [None],
