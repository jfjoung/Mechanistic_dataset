class_reaction_templates={
    ...
    {'Condensation using DCC': {'Reagent': ['[N]=[C]=[N]','[#8]=[#6]-[#8]','[#7,#16]',], 'Exclude_reagent': ['[OH1]-[#7]1[#7][#7][#6][#6]1'],
   'Stages': {0: {'Templates': ['[#6:2]-[N;H0;+0:3]=[C;H0;+0:4]=[N;H0;+0:5]-[#6:6].[O;H1;+0:1]-[C;H0;+0:14](-[#6:13])=[O:15]>>[#6:2]-[N;H1;+1:3]=[C;H0;+0:4]=[N;H0;+0:5]-[#6:6].[O;H0;-1:1]-[C;H0;+0:14](-[#6:13])=[O:15]',],
    ...
    2: {'Templates': ['[N;H3;+0:8].[#6:2]-[N;H1;+0:3]-[C;H0;+0:4]([O;H0;+0:1]-[C;H0;+0:14](-[#6:13])=[O:15])=[N;H0;+0:5]-[#6:6]>>[#6:2]-[N;H1;+0:3]-[C;H0;+0:4]([O;H0;+0:1]-[C;H0;+0:14]([N;H3;+1:8]-[*:7])(-[#6:13])-[O;-1:15])=[N;H0;+0:5]-[#6:6]',
      ...
      '[*:7]-[S;H1;+0:8].[#6:2]-[N;H1;+0:3]-[C;H0;+0:4]([O;H0;+0:1]-[C;H0;+0:14](-[#6:13])=[O:15])=[N;H0;+0:5]-[#6:6]>>[#6:2]-[N;H1;+0:3]-[C;H0;+0:4]([O;H0;+0:1]-[C;H0;+0:14]([S;H1;+1:8]-[*:7])(-[#6:13])-[O;-1:15])=[N;H0;+0:5]-[#6:6]',],
    ...
    3: {'Templates': ['[#6:2]-[N;H1;+0:3]-[C;H0;+0:4]([O;H0;+0:1]-[C;H0;+0:14](-[#7;+1:8]-[*:7])(-[#6:13])-[O;-1:15])=[N;H0;+0:5]-[#6:6]>>[#6:2]-[N;H1;+0:3]-[C;H0;+0:4]([O;H0;-1:1])=[N;H0;+0:5]-[#6:6].[#6:13]-[C;H0;+0:14](-[N;+1:8]-[*:7])=[O;+0:15]',
      '[#6:2]-[N;H1;+0:3]-[C;H0;+0:4]([O;H0;+0:1]-[C;H0;+0:14](-[#16;+1:8]-[*:7])(-[#6:13])-[O;-1:15])=[N;H0;+0:5]-[#6:6]>>[#6:2]-[N;H1;+0:3]-[C;H0;+0:4]([O;H0;-1:1])=[N;H0;+0:5]-[#6:6].[#6:13]-[C;H0;+0:14](-[#16;+1:8]-[*:7])=[O;+0:15]',
    ...
    4: {'Templates': ['[#6:2]-[N;H1;+0:3]-[C;H0;+0:4](-[O;H0;-1:1])=[N;H0;+0:5]-[#6:6].[C;H0;+0:14](-[#7;H3;+1:8]-[*:7])(-[#6:13])=[O;+0:15]>>[#6:2]-[N;H1;+0:3]-[C;H0;+0:4](=[O;H0;+0:1])-[N;H1;+0:5]-[#6:6].[C;H0;+0:14](-[#7;H2;+0:8]-[*:7])(-[#6:13])=[O;+0:15]',
      ...
      '[#6:2]-[N;H1;+0:3]-[C;H0;+0:4](-[O;H0;-1:1])=[N;H0;+0:5]-[#6:6].[#16;H1;+1:8]>>[#6:2]-[N;H1;+0:3]-[C;H0;+0:4](=[O;H0;+0:1])-[N;H1;+0:5]-[#6:6].[#16;H0;+0:8]',
      '[#6:2]-[N;H1;+0:3]-[C;H0;+0:4](-[O;H0;-1:1])=[N;H0;+0:5]-[#6:6].[C;H0;+0:14](-[#16;H1;+1:8])(-[#6:13])=[O;+0:15]>>[#6:2]-[N;H1;+0:3]-[C;H0;+0:4](=[O;H0;+0:1])-[N;H1;+0:5]-[#6:6].[C;H0;+0:14](-[#16;H0;+0:8])(-[#6:13])=[O;+0:15]',
...
'Condensation using DCC and HOBt': {'Reagent': ['[N]=[C]=[N]','[#8]=[#6]-[#8]','[#7,#16]', '[OH1]-[#7]1[#7][#7][#6][#6]1'], 'Exclude_reagent': None,
   'Stages': {0: {'Templates': ['[#6:2]-[N;H0;+0:3]=[C;H0;+0:4]=[N;H0;+0:5]-[#6:6].[O;H1;+0:1]-[C;H0;+0:14](-[#6:13])=[O:15]>>[#6:2]-[N;H1;+1:3]=[C;H0;+0:4]=[N;H0;+0:5]-[#6:6].[O;H0;-1:1]-[C;H0;+0:14](-[#6:13])=[O:15]',],
     'pKa': [None],
     'Description': 'Proton exchange'},
    ...
    3: {'Templates': ['[*:7]-[N;H3;+0:8].[#7;+0:21]-[O;H0;+0:20]-[C;H0;+0:14](-[#6:13])=[O:15]>>[#7;+0:21]-[O;H0;-1:20].[*:7]-[N;H3;+1:8]-[C;H0;+0:14](-[#6:13])=[O:15]',
      ...
      '[*:7]-[S;H1;+0:8].[#7;+0:21]-[O;H0;+0:20]-[C;H0;+0:14](-[#6:13])=[O:15]>>[#7;+0:21]-[O;H0;-1:20].[*:7]-[S;H1;+1:8]-[C;H0;+0:14](-[#6:13])=[O:15]',],
     'pKa': [None,None, None, None],
    ...
    4: {'Templates': ['[#7;+0:21]-[O;H0;-1:20].[*:7]-[N;H3;+1:8]-[C;H0;+0:14](-[#6:13])=[O:15]>>[#7;+0:21]-[O;H1;+0:20].[*:7]-[N;H2;+0:8]-[C;H0;+0:14](-[#6:13])=[O:15]',
        '[#7;+0:21]-[O;H0;-1:20].[*:7]-[N;H2;+1:8]-[C;H0;+0:14](-[#6:13])=[O:15]>>[#7;+0:21]-[O;H1;+0:20].[*:7]-[N;H1;+0:8]-[C;H0;+0:14](-[#6:13])=[O:15]',
                     ...
                     '[#7;+0:21]-[O;H0;-1:20].[*:7]-[S;H1;+1:8]-[C;H0;+0:14](-[#6:13])=[O:15]>>[#7;+0:21]-[O;H1;+0:20].[*:7]-[S;H0;+0:8]-[C;H0;+0:14](-[#6:13])=[O:15]',
                      ],
...
'Condensation using HATU/HBTU': {'Reagent': ['[#8]=[#6]-[#8]','[#7,#16]', '[#7;+1]=[#6](-[*])-[#7]'], 'Exclude_reagent': None,
   'Stages': {
...
'Condensation using CDI': {'Reagent': ['[#8]=[#6]-[#8]','[#7,#16]', '[n]-[C](=[O])-[n]'], 'Exclude_reagent': None,
   'Stages': {
   ...
   2: {'Templates': ['[O:1]=[C:2][O:3][C:4](=[O:10])([N:5]1[C:6]=[C:7][N:8]=[C:9]1).[N:11]1=[C:12]-[N;H1;+0:13][C:14]=[C:15]1>>[O:1]=[C:2]-[N:11]1-[C:12]=[N;H0;+0:13][C:14]=[C:15]1.[O:3]=[C:4]=[O:10].[N;H1;+0:5]1[C:6]=[C:7][N:8]=[C:9]1'],
    ...
    3: {'Templates': ['[N;H3;+0:9].[O:1]=[C:2]-[N:3]1-[C:4]=[N:5][C:6]=[C:7]1>>[N;H3;+1:9]-[C:2]=[O:1].[N;-1:3]1-[C:4]=[N:5][C:6]=[C:7]1',
      ...
      '[*:8]-[S;H1;+0:9].[O:1]=[C:2]-[N:3]1-[C:4]=[N:5][C:6]=[C:7]1>>[*:8]-[S;H1;+1:9]-[C:2]=[O:1].[N;-1:3]1-[C:4]=[N:5][C:6]=[C:7]1',],
     'pKa': [None, None, None, None],
    ...
    4: {'Templates': ['[N;H3;+1:9]-[C:2]=[O:1].[N;-1:3]1-[C:4]=[N:5][C:6]=[C:7]1>>[N;H2;+0:9]-[C:2]=[O:1].[N;+0;H1:3]1-[C:4]=[N:5][C:6]=[C:7]1',
                      ...
                      '[S;H1;+1:9]-[C:2]=[O:1].[N;-1:3]1-[C:4]=[N:5][C:6]=[C:7]1>>[S;H0;+0:9]-[C:2]=[O:1].[N;+0;H1:3]1-[C:4]=[N:5][C:6]=[C:7]1',
                      ],
     'pKa': [None, None, None,None],
     'Description': 'Proton exchange between amide and imidazole'}}},

'Condensation using BOP': {'Reagent': ['[#8]=[#6]-[#8]','[#7,#16]', '[#7]-[O]-[P+]'], 'Exclude_reagent': None,
   'Stages': {
  ...
  'Condensation without catalyst': {'Reagent': ['[#8]-[#6]=[#8]','[#7,#16]',], 'Exclude_reagent': ['[N]=[C]=[N]','[#7;+1]=[#6](-[*])-[#7]', '[n]-[C](=[O])-[n]', '[#7]-[O]-[P+]'],
'Stages': {0: {'Templates': ['[N;H3;+0:5].[O:1]-[C;H0;+0:14](-[#6:13])=[O:15]>>[#6:13]-[C;H0;+0:14](-[O;-1:15])(-[O:1])-[N;H3;+1:5]',
                                ...
                                '[S;H1;+0:5].[O:1]-[C;H0;+0:14](-[#6:13])=[O:15]>>[#6:13]-[C;H0;+0:14](-[O;-1:15])(-[O:1])-[S;H1;+1:5]',
                                ],
     'pKa': [None, None, None],
    ...
    1: {'Templates': ['[#6:13]-[C;H0;+0:14](-[O;-1:15])(-[O:1])-[#7;H3;+1:5]>>[#6:13]-[C;H0;+0:14](-[O;-1:15])(-[O:1])-[#7;H2;+0:5]',
      ...
      '[#6:13]-[C;H0;+0:14](-[O;-1:15])(-[O:1])-[S;H1;+1:5]>>[#6:13]-[C;H0;+0:14](-[O;-1:15])(-[O:1])-[S;H0;+0:5]',],
    ...
    2: {'Templates': ['[#6:13]-[C;H0;+0:14](-[O;-1:15])(-[O:2])-[N;+0:5]>>[#6:13]-[C;H0;+0:14](=[O;+0:15])-[N;+0:5].[O;-1:2]',
      '[#6:13]-[C;H0;+0:14](-[O;-1:15])(-[O:2])-[S;+0:5]>>[#6:13]-[C;H0;+0:14](=[O;+0:15])-[S;+0:5].[O;-1:2]',],
     'pKa': [None],
