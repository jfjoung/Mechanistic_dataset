...
'Condensation using CDI': {'Reagent': ['[#8]=[#6]-[#8]','[#7,#16,#8]', '[#7]-[#6](=[#8])-[#7]'], 'Exclude_reagent': None,
   ...
   2: {'Templates': ['[O:1]=[C:2][O:3][C:4](=[O:10])([N:5]1[C:6]=[C:7][N:8]=[C:9]1).[N:11]2=[C:12]-[N;H1;+0:13][C:14]=[C:15]2>>[O;-1:1]-[C:2](-[N;+1:11]1=[C:12]-[N;H1;+0:13][C:14]=[C:15]1)-[O:3]-[C:4](=[O:10])-[N:5]2[C:6]=[C:7][N:8]=[C:9]2'],
      'pKa': [None],
      'Description': 'Addition of imidazole into carboxylic acid-CDI'},

   3: {'Templates': ['[O;-1:1]-[C:2](-[N;+1:11]1=[C:12]-[N;H1;+0:13][C:14]=[C:15])[O:3][C:4](=[O:10])([N:5]1[C:6]=[C:7][N:8]=[C:9]1)>>[O:1]=[C:2]-[N:11]1-[C:12]=[N;H0;+0:13][C:14]=[C:15]1.[O:3]=[C:4]=[O:10].[N;H1;+0:5]1[C:6]=[C:7][N:8]=[C:9]1'],
      'pKa': [None],
      'Description': 'Addition of imidazole into carboxylic acid-CDI'},

    4: {'Templates': ['[N;H3;+0:9].[O:1]=[C:2]-[N:3]1-[C:4]=[N:5][C:6]=[C:7]1>>[N;H3;+1:9]-[C:2]-[O;-1:1]-[N;+0:3]1-[C:4]=[N:5][C:6]=[C:7]1',
    ...
    5: {'Templates': ['[N;H3;+1:9]-[C:2]-[O;-1:1]-[N;+0:3]1-[C:4]=[N:5][C:6]=[C:7]1>>[N;H3;+1:9]-[C:2]=[O:1].[N;-1:3]1-[C:4]=[N:5][C:6]=[C:7]1',
