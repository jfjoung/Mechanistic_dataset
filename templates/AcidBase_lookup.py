Acid_base = [
    ...
    # Hydride
    {'Acid': '[#1;H1;+0:100]','Base': '[#1;-1:100]', 'pKa': 35, 'role' : ['B']},
    {'Acid': '[#1;H1;+0:100].[Li,Na,K;+1:99]','Base': '[Li,Na,K;+0:99]-[#1;+0:100]', 'pKa': 35, 'role' : ['B']},
    ...
    {'Acid': '[C;!$([C]=[O]):100][O;H2;+1:99]', 'Base': '[C;!$([C]=[O]):100][O;H1;+0:99]', 'pKa':-2, 'role' : ['A', 'B']},
    {'Acid': '[C;!$([C]=[O]):100][O;H1;+1:99][C;!$([C]=[O]):98]', 'Base': '[C;!$([C]=[O]):100][O;H0;+0:99][C;!$([C]=[O]):98]', 'pKa':-2, 'role' : ['A', 'B']},
    ...
    {'Acid': '[O:100]=[P:99]([O;H1;+0:98])([O;H0;+0:97][*:95])[*:94]', 'Base': '[O:100]=[P:99]([O;H0;-1:98])([O;H0;+0:97][*:95])[*:94]', 'pKa': 1.5, 'role' : ['A', 'B']},
    {'Acid': '[O:100]=[P:99]([O;H1;+0:98])([*:95])[O;H1;+0:96]', 'Base': '[O:100]=[P:99]([O;H0;-1:98])([*:95])[O;H1;+0:96]', 'pKa': 1.0, 'role' : ['A', 'B']},
    ...
    #Carboxylate
    {'Acid': '[!O:97]-[C:100](=[O:99])[O;H1;+0:98]' , 'Base': '[!O:97]-[C:100](=[O:99])[O;H0;-1:98]', 'pKa': 4.74, 'role' : ['A', 'B']},
    {'Acid': '[!O:97]-[C:100](=[O:99])[O;H1;+0:98].[Li,Na,K;+1:97]' , 'Base': '[!O:97]-[C:100](=[O:99])[O;H0;+0:98][Li,Na,K;+0:97]', 'pKa': 4.74, 'role' : ['B']},
    ...
    {'Acid': '[O;H1;+0:97][C:100](=[O:99])[O;H1;+0:98]' , 'Base': '[O;H1;+0:97][C:100](=[O:99])[O;H0;-1:98]', 'pKa': 6.38, 'role' : ['A', 'B']}, #Carbonate
    {'Acid': '[O;H1;+0:97][C:100](=[O:99])[O;H1;+0:98].[Li,Na,K;+1:96]' , 'Base': '[O;H1;+0:97][C:100](=[O:99])[O;H0;+0:98][Li,Na,K;+0:96]', 'pKa': 6.38, 'role' : ['B']}, #Carbonate
    {'Acid': '[O;H1;+0:97][C:100](=[O:99])[O;H0;-1:98]' , 'Base': '[O;H0;-1:97][C:100](=[O:99])[O;H0;-1:98]', 'pKa': 10.34, 'role' : ['A', 'B']}, #Carbonate
    {'Acid': '[O;H1;+0:97][C:100](=[O:99])[O;H0;+0:98][Li,Na,K;+1:96]' , 'Base': '[O;H0;-1:97][C:100](=[O:99])[O;H0;+0:98][Li,Na,K;+0:96]', 'pKa': 10.34, 'role' : ['B']}, #Carbonate
    {'Acid': '[O;H1;+0:97][C:100](=[O:99])[O;H0;+0:98][Li,Na,K;+0:96].[Li,Na,K;+1:95]' , 'Base': '[Li,Na,K;+0:95][O;H0;+0:97][C:100](=[O:99])[O;H0;+0:98][Li,Na,K;+0:96]', 'pKa': 10.34, 'role' : ['B']}, #Carbonate
    ...
    #Solvents
    {'Acid': '[C;+0:100][C:99]#[N;H1;+1:98]', 'Base': '[C;+0:100][C:99]#[N;H0;+0:98]', 'pKa': -10, 'role' : ['A', 'B']}, #Nitrile
