Acid_base = [
    ...
    {'Acid' :'[C;!$(C=O):100][N;H1;+1:99]([C;!$(C=O):98])[C;!$(C=O):97]' , 'Base': '[C;!$(C=O):100][N:99]([C;!$(C=O):98])[C;!$(C=O):97]', 'pKa': 10.8, 'role' : ['A', 'B']},
    {'Acid' :'[C;!$(C=O):100][N;H2;+1:99][C;!$(C=O):98]', 'Base': '[C;!$(C=O):100][N;H1;+0:99][C;!$(C=O):98]', 'pKa': 11, 'role' : ['A', 'B']},
    {'Acid' :'[C;!$(C=O):100][N;H3;+1:99]' , 'Base': '[C;!$(C=O):100][N;H2;+0:99]', 'pKa': 10.6, 'role' : ['A', 'B']},
