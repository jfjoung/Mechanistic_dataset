Acid_base = [
    ...
    {'Acid' :'[C;!$(C=*):100]-[N;D3;H1;+1:99](-[C;!$(C=*):98])-[C;!$(C=*):97]' , 'Base': '[C;!$(C=*):100]-[N;D3;+0:99](-[C;!$(C=*):98])-[C;!$(C=*):97]', 'pKa': 10.8, 'role' : ['A', 'B']},
    ...
    {'Acid': '[C:100][N;H1;+1&!$([#7]~[#7]):99]=[C;H0:98][N;H0:97]','Base':'[C:100][N;+0;H0&!$([#7]~[#7]):99]=[C;H0:98][N;H0:97]', 'pKa': 13.4, 'role' : ['A', 'B']},
